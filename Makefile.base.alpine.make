...
build-all-alpine312py37: build-base-alpine312py37-ansb210
build-all-alpine312py37: build-base-alpine312py37-ans210
...
build-base-alpine: build-base-alpine312py37
build-base-alpine: build-base-alpine312
# build-base-alpine: build-base-alpine311

build-base-alpine: build-base-alpineedge-ansb
build-base-alpine: build-base-alpine312py37-ansb210
build-base-alpine: build-base-alpine312py37-ans210
...
build-base-alpine312py37:                                  r--build-base-alpine312py37
...
build-base-alpine312py37-ansb210:     build-base-alpine312   r--build-base-alpine312py37-ansb210
build-base-alpine312py37-ans210:     build-base-alpine312   r--build-base-alpine312py37-ans210
...
pull-base-alpine312py37:  r--pull-base-alpine312py37-ansb210
pull-base-alpine312py37:  r--pull-base-alpine312py37-ans210
...
push-base-alpine312py37:   r--push-base-alpine312py37-ansb210
push-base-alpine312py37:   r--push-base-alpine312py37-ans210
...
shell-base-alpine312py37:        r--shell-base-alpine312py37
...
shell-base-alpine312py37-ansb210: r--shell-base-alpine312py37-ansb210
shell-base-alpine312py37-ans210: r--shell-base-alpine312py37-ans210
...
test-base-alpine:        test-base-alpine312py37
test-base-alpine:        test-base-alpine312

#test-base-alpine:        test-base-alpineedge-ans
test-base-alpine:        test-base-alpineedge-ansb
test-base-alpine:        test-base-alpine312py37-ansb210
test-base-alpine:        test-base-alpine312py37-ans210
...
test-base-alpine312py37:        r--test-base-alpine312py37$(TEST_TAG)
...
test-base-alpine312py37-ansb210:    r--test-base-alpine312py37-ansb210$(TEST_TAG)
test-base-alpine312py37-ans210:     r--test-base-alpine312py37-ans210$(TEST_TAG)
